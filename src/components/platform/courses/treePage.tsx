...
const TreePage: React.FC<TreePageProps> = ({ sectionTitle }) => {
  ...
  const tawjihiTeachers: Teacher[] = [
    { id: 1, name: "أ. محمد الأحمد", subject: "الرياضيات", rating: 4.9, students: 1200, experience: 15, image: "https://images.pexels.com/photos/5212324/pexels-photo-5212324.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 2, name: "أ. فاطمة السعد", subject: "الفيزياء", rating: 4.8, students: 980, experience: 12, image: "https://images.pexels.com/photos/5212317/pexels-photo-5212317.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 3, name: "أ. أحمد الخالد", subject: "الكيمياء", rating: 4.9, students: 1100, experience: 18, image: "https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 4, name: "أ. نور العلي", subject: "الأحياء", rating: 4.7, students: 850, experience: 10, image: "https://images.pexels.com/photos/5212700/pexels-photo-5212700.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 5, name: "أ. سامر الحسن", subject: "اللغة العربية", rating: 4.8, students: 1300, experience: 20, image: "https://images.pexels.com/photos/5428836/pexels-photo-5428836.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 6, name: "أ. ليلى المحمود", subject: "اللغة الإنجليزية", rating: 4.9, students: 1150, experience: 14, image: "https://images.pexels.com/photos/5212317/pexels-photo-5212317.jpeg?auto=compress&cs=tinysrgb&w=150" }
  ];

  const basicTeachers: Teacher[] = [
    { id: 7, name: "أ. خالد الزهراني", subject: "الرياضيات", rating: 4.8, students: 800, experience: 12, image: "https://images.pexels.com/photos/5212324/pexels-photo-5212324.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 8, name: "أ. هدى الشامي", subject: "العلوم", rating: 4.7, students: 650, experience: 9, image: "https://images.pexels.com/photos/5212700/pexels-photo-5212700.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 9, name: "أ. عمر الطيب", subject: "اللغة العربية", rating: 4.9, students: 900, experience: 16, image: "https://images.pexels.com/photos/5428836/pexels-photo-5428836.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 10, name: "أ. رنا القاسم", subject: "اللغة الإنجليزية", rating: 4.6, students: 720, experience: 8, image: "https://images.pexels.com/photos/5212317/pexels-photo-5212317.jpeg?auto=compress&cs=tinysrgb&w=150" },
    { id: 11, name: "أ. يوسف الدين", subject: "الاجتماعيات", rating: 4.8, students: 600, experience: 13, image: "https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&cs=tinysrgb&w=150" }
  ];
      ...
      <div key={node.id} className="mb-4">
        <div
          className={`flex items-center space-x-3 p-4 rounded-xl cursor-pointer transition-all duration-300 hover:bg-gradient-to-r hover:from-yellow-50 hover:to-orange-50 ${
            level === 0 ? 'bg-white shadow-md border border-gray-100' : 'bg-gray-50 hover:bg-gray-100'
          }`}
        ...
        >
          ...
          {IconComponent && (
            <div className={`flex items-center justify-center w-10 h-10 rounded-xl ${
              level === 0 ? 'bg-gradient-to-r from-yellow-500 to-orange-500' : 'bg-gray-200'
            }`}>
              <IconComponent className={`w-5 h-5 ${level === 0 ? 'text-white' : 'text-gray-600'}`} />
            </div>
          )}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-4 text-white">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-yellow-100">تقييم</div>
              </div>
            </div>
          </div>
        </div>
