...
import { ChevronLeft, ChevronRight, Play, Star, Users, Award, BookOpen } from 'lucide-react';
  ...
  const slides = [
    {
      ...
      description: "أفضل الدورات والمواد التعليمية لضمان نجاحك في التوجيهي وتحقيق أحلامك الجامعية",
    ...
    },
    {
      ...
      description: "نظام امتحانات الكتروني متطور يحاكي الامتحان الحقيقي مع تقييم فوري ونصائح للتحسين",
      ...
      <div className="relative z-20 h-full flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Text Content */}
            <div className={`text-white space-y-8 transform transition-all duration-1000 ${mounted ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
            ...
            {/* Video/Image Preview */}
            <div className={`relative transform transition-all duration-1000 delay-300 ${mounted ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
