...
const AnimatedBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        className="absolute inset-0 bg-gradient-to-tr from-orange-200/20 via-transparent to-orange-300/15 animate-pulse"
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-20 right-20 w-40 h-40 bg-gradient-to-br from-orange-300/15 to-orange-400/10 rounded-full animate-float shadow-2xl"
          style={{ animationDuration: "8s" }}
        ></div>
        <div
          className="absolute bottom-32 left-16 w-32 h-32 bg-gradient-to-br from-orange-200/20 to-orange-300/15 rounded-full animate-float shadow-xl"
          style={{ animationDuration: "10s", animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 right-1/4 w-24 h-24 bg-gradient-to-br from-orange-400/12 to-orange-500/8 rounded-full animate-float shadow-lg"
          style={{ animationDuration: "12s", animationDelay: "4s" }}
        ></div>

        {/* Medium floating shapes */}
        <div
          className="absolute top-1/3 left-1/4 w-20 h-20 bg-gradient-to-br from-orange-300/18 to-orange-400/12 rounded-full animate-pulse shadow-md"
          style={{ animationDuration: "6s" }}
        ></div>
        <div
          className="absolute bottom-1/4 right-1/3 w-16 h-16 bg-gradient-to-br from-orange-200/25 to-orange-300/18 rounded-full animate-pulse shadow-sm"
      ...
      <div className="absolute inset-0">
        ...
        {/* Diamond shapes */}
        <div
          className="absolute top-1/2 left-16 w-14 h-14 bg-gradient-to-br from-orange-300/20 to-transparent transform rotate-45 animate-pulse shadow-lg"
          style={{ animationDuration: "8s" }}
        ></div>
        <div
          className="absolute bottom-1/3 right-20 w-10 h-10 bg-gradient-to-br from-orange-400/25 to-transparent transform rotate-45 animate-pulse shadow-md"
      ...
      <div className="absolute inset-0">
        <div
          className="absolute top-0 left-0 right-0 h-full bg-gradient-to-r from-transparent via-orange-200/8 to-transparent animate-pulse"
          style={{ animationDuration: "12s" }}
        ></div>
        <div
          className="absolute top-0 left-0 right-0 h-full bg-gradient-to-l from-transparent via-orange-300/6 to-transparent animate-pulse"
      ...
      <div className="absolute inset-0 opacity-30">
        <div
          className="absolute top-1/4 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-orange-300/40 to-transparent animate-pulse"
          style={{ animationDuration: "10s" }}
        ></div>
        <div
          className="absolute top-3/4 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-orange-400/35 to-transparent animate-pulse"
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-orange-100/20 via-transparent to-orange-200/15"></div>
